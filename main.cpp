...
int main()
{
    ...
    unsigned int vertexShader; // id reference to vertex shader object
    ...
    unsigned int fragmentShader; // id reference to fragment shader object
    ...
    unsigned int shaderProgram; // id reference to program object
